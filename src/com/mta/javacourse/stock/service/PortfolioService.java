...
import com.mta.javacourse.stock.dto.PortfolioTotalStatus;
import com.mta.javacourse.stock.exception.BalanceException;
import com.mta.javacourse.stock.exception.IllegalQuantityException;
...
import com.mta.javacourse.stock.exception.SymbolNotFoundInNasdaq;
...
public class PortfolioService {
	...
	public void update() {
		...
		for (StockStatus stockStatus : stocks) {
			symbols.add(stockStatus.getSymbolName());
		}
	...
	public PortfolioTotalStatus[] getPortfolioTotalStatus () {
		...
		for (int i = 0; i < stocks.length; i++) {
			...
			if(stock != null) {
				List<StockStatus> history = datastoreService.getStockHistory(stock.getSymbolName(), DAYS_BACK);
	...
	public void addStock(String symbol) throws StockAlreadyExistException, PortfolioFullException, StockNotExistException, SymbolNotFoundInNasdaq {
		Portfolio portfolio = getPortfolio();
