...
import com.mta.javacourse.stock.dto.NasdaqSymbolDto;
...
public class MarketService {
	...
	private List<com.mta.javacourse.stock.dto.NasdaqSymbolDto> nasdaqSymbols;
	...
	public Stock getStock(String symbol) throws com.mta.javacourse.stock.exception.SymbolNotFoundInNasdaq {
	...
	private Stock fromJson(JSONObject stockJson) {
		try {
			Stock ret = new Stock();
			ret.setSymbolName(stockJson.getString("Symbol"));
